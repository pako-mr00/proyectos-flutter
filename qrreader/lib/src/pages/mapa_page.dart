...
_crearMapa() {
    ...
    return TileLayerOptions(
      urlTemplate: 'https://api.mapbox.com/styles/v1/mapbox/$tipoMapa/'
      '{id}/{z}/{x}/{y}@2x?access_token={accessToken}',
      additionalOptions: {
        'accessToken': 'pk.eyJ1IjoicGFrbzIwMDAiLCJhIjoiY2tnZmp2MTRkMG9vYzJ4cGE3ZDRxcGZ1MyJ9.pZHJsLx5kd7vLuI9Tc0XOw',
        'id': 'tiles'
      }
    );
  }
